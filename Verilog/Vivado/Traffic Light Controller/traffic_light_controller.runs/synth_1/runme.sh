...
HD_PWD='C:/Users/sachi/Vivado/Practice/traffic_light_controller/traffic_light_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_controller.tcl
