...
REM
REM Generated by Vivado on Wed Jan 14 11:04:57 +0000 2026
...
echo "xvlog --incr --relax -prj tb_traffic_controller_vlog.prj"
call xvlog  --incr --relax -prj tb_traffic_controller_vlog.prj -log xvlog.log
