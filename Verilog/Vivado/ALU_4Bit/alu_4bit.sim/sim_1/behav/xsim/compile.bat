...
REM
REM Generated by Vivado on Sun Jan 04 09:53:57 +0000 2026
...
echo "xvlog --incr --relax -prj tb_alu_4bit_vlog.prj"
call xvlog  --incr --relax -prj tb_alu_4bit_vlog.prj -log xvlog.log
