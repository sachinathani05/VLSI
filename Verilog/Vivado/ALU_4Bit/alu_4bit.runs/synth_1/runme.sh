...
HD_PWD='C:/Users/sachi/Vivado/Practice/alu_4bit/alu_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_alu_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_alu_4bit.tcl
